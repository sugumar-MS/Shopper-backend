...
mongoose.connect("mongodb+srv://msugumar832:sugumar1607@cluster0.ehhxmli.mongodb.net/e-commerce", {
...
app.post('/addproduct', async (req, res) => {
    ...
    // const id = products.length? products.id+1:1;
...
//creating endpoint for adding products in caartdata
